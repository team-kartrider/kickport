...
public class Register extends AppCompatActivity {
    ...
    private EditText join_email, join_password, join_name, join_pwck, join_year, join_month, join_day, join_phone, join_guardphone, join_insurance;
    private Button join_button, check_button;
    private AlertDialog dialog;
    private boolean validate = false;

    @SuppressLint("WrongViewCast") // 수정요망...?
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        join_pwck = findViewById(R.id.join_check_password);
        ...
        //아이디 중복 체크
        check_button = findViewById(R.id.check_email);
        ...
        //회원가입 버튼 클릭 시 수행
        join_button = findViewById( R.id.join_end );
        join_button.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final String UserYear = join_year.getText().toString();
                final String UserMonth = join_month.getText().toString();
                final String UserDay = join_day.getText().toString();
                final String UserPhone = join_phone.getText().toString();
                final String UserGuardPhone = join_guardphone.getText().toString();
                final String UserInsurance = join_insurance.getText().toString();
